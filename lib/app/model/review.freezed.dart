...
abstract class $ReviewCopyWith<$Res> {
  ...
  $Res call({int id, String name, String date, int rate, String text});
}
...
class _$_Review implements _Review {
  ...
  @override
  String toString() {
    return 'Review(id: $id, name: $name, date: $date, rate: $rate, text: $text)';
  }
  ...
  @override
  int get hashCode => Object.hash(runtimeType, id, name, date, rate, text);
