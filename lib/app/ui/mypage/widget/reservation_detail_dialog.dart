...
class ReservationDetailDialog extends ConsumerWidget {
  const ReservationDetailDialog({
    Key? key,
    required this.reservationData,
  }) : super(key: key);

  final MypageData reservationData;
      ...
      child: Container(
        ...
        child: Column(
          ...
          children: [
            ...
            Text(
              shopTypeToString(reservationData.shop.type),
              ...
              children: [
                ...
                InkWell(
                  onTap: () {
                    ...
                    showDialog(
                      context: context,
                      builder: (context) => ReservationDeleteDialog(
                        reservationId: reservationData.id,
                      ),
                    );
                  },
